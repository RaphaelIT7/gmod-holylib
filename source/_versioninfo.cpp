...
const char* HolyLib_GetPluginDescription()
{
	...
	return "HolyLib Serverplugin V0.9 DEV (Workflow: " HOLYLIB_BUILD_RUN_NUMBER " - Branch: " HOLYLIB_BUILD_BRANCH ")";
#else
	return "HolyLib Serverplugin V0.9 (Workflow: " HOLYLIB_BUILD_RUN_NUMBER " - Branch: " HOLYLIB_BUILD_BRANCH ")";
#endif
}
