...
const char* HolyLib_GetPluginDescription()
{
	...
	return "HolyLib Serverplugin V0.8-pre-hotfix1 DEV (Workflow: " HOLYLIB_BUILD_RUN_NUMBER " - Branch: " HOLYLIB_BUILD_BRANCH ")";
#else
	return "HolyLib Serverplugin V0.8-pre-hotfix1";
#endif
}

const char* HolyLib_GetVersion()
{
	return "0.8-pre-hotfix1";
}
