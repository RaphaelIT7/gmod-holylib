...
extern bool COM_BufferToBufferCompress_LZ4(void* dest, unsigned int* destLen, const void* source, unsigned int sourceLen);
 ...
 */
extern bool COM_Compress_LZ4(const void* source, unsigned int sourceLen, void** dest, unsigned int* destLen);
