...
// Don't use, removed in newer versions! #define BASS_CONFIG_VISTA_TRUEPOS	30
...
#if 0 // Don't use, removed in newer bass versions.
...
#if 0 // Removed in newer bass versions!
